 # Generated by Powerlevel10k configuration wizard on 2021-03-17 at 17:15 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='  '  # circle
  # typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='  '  # circle
  ...
  function prompt_parentesis_left() {
    if git status &> /dev/null; then
      # p10k segment -b $POWERLEVEL9K_DIR_SHORTENED_FOREGROUND -f $POWERLEVEL9K_DIR_SHORTENED_FOREGROUND -i '('
      p10k segment -b red -f  red -i '('
    fi
  }

  function prompt_parentesis_right() {
    if git status &> /dev/null; then
      # p10k segment -b $POWERLEVEL9K_DIR_SHORTENED_FOREGROUND -f $POWERLEVEL9K_DIR_SHORTENED_FOREGROUND -i ')'
      p10k segment -b red -f  red -i ')'
    fi
  ...
  function prompt_my_extra_icon() {
    # p10k segment -b yellow -f $POWERLEVEL9K_DIR_SHORTENED_FOREGROUND -i $'\uf554'
    p10k segment -b yellow -f yellow -i '   ' # arrow
    # p10k segment -b yellow -f yellow -i '   $' # arrow
  }

  function prompt_my_extra_icon2() {
    # p10k segment -b yellow -f green -i ']'
    p10k segment -b yellow -f green -i ']'
  }
